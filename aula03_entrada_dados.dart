...
void main() {
  ...
  // - int.tryParse() retorna int? (pode ser null se não for numero válido)
  int? idade = (inputIdade != null && inputIdade.isNotEmpty)
      ? int.tryParse(inputIdade)
      : null;

  // Se idade for null, siginifica que a conversão falhou -> mensagem de erro
  if (idade == null) {
