void main() {
  ...
  */
  ...
  print('Map transformando em String: ${resultado.join(', ')}');
  print('-' * 70);
  ...
  var precos = {'banana': 2.5, 'maça': 3.0, 'laranja': 2.0};
  ...
  // Convertendo cada par de chave/valor em uma frase decritiva
  var descricoes = estoque.entries.map(
    (item) => 'Temos ${item.value} unidades de ${item.key}.',
  );

  // .toList() transforma o Iterble em uma lista
