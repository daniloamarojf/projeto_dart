...
class Aluno {
  ...
  // Cobrescrita (override) do método toString para exibir o boletim formatado
  @override
  String toString() {
...
void main() {
  ...
  do {
    ...
    for (int i = 1; i <= 4; i++) {
      ...
      notas['n$i'] = nota; // Armazena no map: "n1": nota, "n2": nota...
    }

    // Cria um objeto Aluno usando o contrutor com parâmentros nomeados
  ...
  // Exibe todos os alunos cadstrados utilizando o toString
